(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=e(s);fetch(s.href,i)}})();function k(r,t=1){const e=new Date(r.getFullYear(),0,1);let n=e.getDay()-t;n=n>=0?n:n+7;const s=Math.floor((r.getTime()-e.getTime()-(r.getTimezoneOffset()-e.getTimezoneOffset())*6e4)/864e5)+1;let i;if(n<4){if(i=Math.floor((s+n-1)/7)+1,i>52){let a=new Date(r.getFullYear()+1,0,1).getDay()-t;a=a>=0?a:a+7,i=a<4?1:53}}else i=Math.floor((s+n-1)/7);return i}function U(r){return r.toISOString().split("T")[0]}function j(r){const t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],e=["January","February","March","April","May","June","July","August","September","October","November","December"],n=t[r.getDay()],s=e[r.getMonth()],i=r.getDate(),o=r.getFullYear();return`${n}, ${s} ${i}, ${o}`}function q(r){let t=r.getHours();const e=r.getMinutes().toString().padStart(2,"0"),n=t>=12?"PM":"AM";return t=t%12,t=t||12,`${t}:${e} ${n}`}function O(r){const e=r.split(",")[1].trim(),n=e.split(" "),s=n[0].substring(0,3),i=n[1];return{shortest:"TODAY",short:`TODAY, ${s} ${i}`,medium:`TODAY, ${s} ${i}`,full:`TODAY, ${e}`,justEmoji:"📅",withEmoji:`📅 ${i} TODAY`,justDate:`${s} ${i}`}}function x(r){const t=r.split(","),e=t[0].trim(),s=t[1].trim().split(" "),i=s[0].substring(0,3),o=s[1],a=parseInt(o,10);let d="";const l=["🗓️","🌈","☀️","🌟","🌙","🚀","⚡"];return d=l[a%l.length],{shortest:e.substring(0,3),short:`${e.substring(0,3)}, ${i} ${o}`,medium:`${e}, ${i} ${o}`,full:r,justEmoji:`${d}`,withEmoji:`${d} ${o} ${e.substring(0,3)}`,justDate:`${i} ${o}`}}const y={INFO_BUTTON:"infoButton",INFO_MODAL:"infoModal",EVENT_LIST:"eventList"},f={DAY_CONTAINER:"day-container",DAY_HEADER:"day-header",EVENT_DAY_CONTAINER:"event-day-container",EVENTBOX:"event-box",EVENT_IMAGE:"event-image",EVENT_TAG:"event-tag",EVENT_DETAILS:"event-details",EVENT_TITLE:"event-title",EVENT_DATE:"event-date",EVENT_LOCATION:"event-location",MODAL_CLOSE:"close",MODAL_CONTENT:"modal-content"},B={FILTERS_CHANGED:"filtersChangedEvent"},$="https://picsum.photos/400/300";function M(r){return r.toLowerCase().replace(/[★*]/g,"").trim()}function Y(r,t,e){const n=e+1;if(r.length<n||t.length<n)return!1;const s=r.toLowerCase(),i=t.toLowerCase();let o,a;s.length<=i.length?(o=s,a=i):(o=i,a=s);const d=new Set,l=o.length-n;for(let c=0;c<=l;c++){const u=o.substring(c,c+n);d.add(u)}const h=a.length-n;for(let c=0;c<=h;c++){const u=a.substring(c,c+n);if(d.has(u))return!0}return!1}const P=["Dining Week","VEGA"],F={HUSET:["Husets Biograf"],"Husets Biograf":["HUSET"]},G=13;function z(r,t){return Array.from(t).some(e=>{var u,m;if(e.date.start.getTime()!==r.date.start.getTime())return!1;const n=e.source.pageName,s=r.source.pageName,i=n===s,o=((u=F[n])==null?void 0:u.includes(s))||((m=F[s])==null?void 0:m.includes(n));if(!i&&!o)return!1;if(P.includes(n))return!0;const a=e.name.toLowerCase().trim(),d=r.name.toLowerCase().trim();if(a===d)return!0;const h=M(r.name),c=M(e.name);return h.includes(c)||c.includes(h)?!0:Y(h,c,G)})}const W="/resources/eventsJSON/",X=4;class J{async loadEventsAsync(t,e,n){const[s,i]=await Promise.all([this.fetchWeekEvents(e),this.fetchWeekEvents(n)]),o=[...s,...i],a=o.filter(l=>l.id==="cphdox-memory-wars");return a.length>0&&console.log("Found cphdox-memory-wars events:",a),this.processEvents(o,e,n)}async fetchWeekEvents(t){function e(o){return o.date.start_timestamp===null&&(o.date.start_timestamp=new Date(t.getFullYear(),2,28,18,0,0).getTime()/1e3,o.date.end_timestamp=o.date.start_timestamp+7200),{id:o.id+o.date.start_timestamp.toString(),name:o.name,description:o.description,category:o.page_name==="CPH DOX"?"CPH:DOX":o.tag,date:{start:new Date(o.date.start_timestamp*1e3),end:new Date(o.date.end_timestamp*1e3),timezone:o.date.timezone},location:{name:o.location.name,fullAddress:o.location.address,city:o.location.city,district:o.location.copenhagen_district,country:o.location.country,coordinates:{latitude:o.location.latitude,longitude:o.location.longitude,bounds_ne_lat:o.location.bounds_ne_lat,bounds_ne_lng:o.location.bounds_ne_lng,bounds_sw_lat:o.location.bounds_sw_lat,bounds_sw_lng:o.location.bounds_sw_lng,plus_code_global:o.location.plus_code_global,plus_code_local:o.location.plus_code_local,plus_code_locality:o.location.plus_code_locality}},media:{imageUrl:o.image_url,videoUrl:o.video_url},source:{url:o.url,pageName:o.page_name,pageUrl:o.page_url,platform:o.platform}}}const n=k(t,1).toString().padStart(2,"0"),s=t.getFullYear().toString(),i=W+`${s}-W${n}.json`;return console.log("Attempting to Load Events from file_name",i),fetch(i).then(o=>o.ok?o.json():[]).then(o=>o.map(e)).catch(o=>(console.error("Error loading events:",o),console.error("Stack trace:",o.stack),[]))}processEvents(t,e,n){const s=new Map,i=new Date;return t.filter(a=>{var c;const d=a.date.start;if(d<new Date(i.getTime()-X*60*60*1e3)||d>n)return console.info(`Event ${a.id} filtered out: outside of time window`),!1;const l=U(d);if(!s.has(l))return s.set(l,[]),(c=s.get(l))==null||c.push(a),!0;const h=s.get(l)||[];return z(a,h)?(console.info(`Event ${a.id} filtered out: duplicate event found on same date ${l}`),!1):(h.push(a),!0)}).sort((a,d)=>a.date.start.getTime()-d.date.start.getTime())}}class K{constructor(){this.hasInitialized=!1,this.dates=new Set,this.events=new Map,this.eventsHTML=new Map}generateEventsHTML(t){if(this.events.values.length>0)throw new Error("generateEventsHTML should only be called once! The events map already contains events.");t.forEach(n=>{this.events.set(n.id,n)});const e=document.getElementById(y.EVENT_LIST);if(!e){console.error(`HTML Page needs DIV ${y.EVENT_LIST}`);return}e.innerHTML=Object.entries(t.reduce((n,s)=>{const i=j(s.date.start);return this.dates.add(i),n[i]=n[i]||[],n[i].push(s),n},{})).map(([n,s])=>`
